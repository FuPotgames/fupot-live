...
@Component({
  selector: 'app-social-locations',
  templateUrl: './social-locations.page.html',
  styleUrls: ['./social-locations.page.scss'],
  animations: [
    trigger('fade', [
...
export class SocialLocationsPage implements OnInit {
  page=1;
  latitude:string;
  longitude:string;
  coordinates;
  reload:boolean = true;
  establishment_type:string = "social"
