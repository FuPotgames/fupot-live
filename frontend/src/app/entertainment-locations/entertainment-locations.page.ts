...
@Component({
  selector: 'app-entertainment-locations',
  templateUrl: './entertainment-locations.page.html',
  styleUrls: ['./entertainment-locations.page.scss'],
  animations: [
    trigger('fade', [
...
export class EntertainmentLocationsPage implements OnInit {
  page=1;
  latitude:string;
  longitude:string;
  coordinates;
  reload:boolean = true;
  establishment_type:string = "entertainment"
